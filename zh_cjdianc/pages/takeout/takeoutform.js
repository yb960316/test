...
Page({
    ...
    hbdkshowcart: function () {
      this.setData({
        hbdkshare_modal_active: !this.data.hbdkshare_modal_active
      });
    },
    hbdkclosecart: function () {
      this.setData({
        hbdkshare_modal_active: !1
      });
    },    
    ...
    onLoad: function(t) {
        ...
        wx.removeStorageSync("note"), app.util.request({
          ...
          url:"entry/wxapp/MyNewCoupons",
          cachetime:"0",
          data:{
            user_id:m
          },
          success:function(e){
            console.log(e,'我的优惠券新');
            u.setData({
              hbdk:e.data
            })
          }
            ...
            success: function(t) {
              console.log(typeof(t.data.reduction),'配送');
