...
Page({
    ...
    spxqck: function(t) {
        var a = t.currentTarget.dataset.itemIndex,
         ...
         o = this.data.dishes, s = this.data.cart_list.res, 
    ...
    onLoad: function(e) {
        console.log("options", e), app.setNavigationBarColor(this), this.setData({
            store_id: e.storeid
        }), this.setData({
            params: {
                store_id: e.storeid,
        ...
        var c = this, t = c.data.store_id, d = util.formatTime(new Date()).slice(11, 16);
        app.util.request({
            ...
            success: function(t) {
                ...
                1 == i ? (c.setData({
                    yysjtoggle: !1
                }), console.log("商家正在休息" + i)) : console.log("商家正在营业" + i), a < s ? a < d && d < e || o < d && d < s ? (console.log("商家正常营业"), 
                c.setData({
                    time: 1
